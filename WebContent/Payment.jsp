        ...
        <section >
           ...
           <section>
               <form action="${pageContext.request.contextPath}/ThankYou.jsp" method="post" class="form-container">
                   <div >
                       <label for="card_details">Bank Name</label>
                       <input type="text" name="name_on_card" placeholder="Enter Bank Name">
                   </div>
                   <div >
                       <label for="card_details">Account Number</label>
                       <input type="number" name="card_details" placeholder="Enter Account Number">
                   </div>
                   <br>
                   <p align="left"><span><strong>Total Amount<br> <%=Booking.ticket_price%> X <%=Search.persons%> persons = Tzs.<%=Booking.ticket_price*Search.persons%></strong></span></p>
                   <button type="submit" value="Submit">Pay Through Bank</button>
               </form>
          </section>
        </section>
    </section>
